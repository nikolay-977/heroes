...
public class GeneratePresetImpl implements GeneratePreset {
    ...
    //  Константа maxUnitsPerType = m = 11 в задаче фиксированная.
    //  Таким образом, внутренний цикл выполняется максимум m * n раз.
    //  Сложность на этом этапе: O(n * m).
    //  Наиболее затратной операцией здесь является сортировка.
    //  Асимптотическая сложность алгоритма составляет: O(nlogn)
    @Override
